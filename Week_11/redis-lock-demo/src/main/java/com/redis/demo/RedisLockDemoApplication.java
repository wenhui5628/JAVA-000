...
import com.redis.demo.lock.RedisLock;
...
public class RedisLockDemoApplication {
    ...
    public static void main(String[] args) throws Exception{
        ...
        Thread thread1 = new Thread(RedisLockDemoApplication::lockTest);
        Thread thread2 = new Thread(RedisLockDemoApplication::lockTest);
        thread1.start();
        thread2.start();
        thread1.join();
        thread2.join();

        Thread thread3 = new Thread(RedisLockDemoApplication::lockTest);
        thread3.start();
        thread3.join();
    }
