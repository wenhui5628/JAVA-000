...
# 在3306上创建数据库demo_ds_0，运行下面的SQL语句初始化数据库和表
mysql -uroot -P 3306
...
# 在3316上创建数据库demo_ds_1，运行下面的SQL语句初始化数据库和表
mysql -uroot -P 3316
...
dataSources:
  ds_0: !!com.zaxxer.hikari.HikariDataSource
    ...
    jdbcUrl: jdbc:mysql://localhost:3306/demo_ds_0?serverTimezone=UTC&useUnicode=true&characterEncoding=utf-8&useSSL=false&allowPublicKeyRetrieval=true
    username: root
    password: 
    autoCommit: false
  ds_1: !!com.zaxxer.hikari.HikariDataSource
    driverClassName: com.mysql.cj.jdbc.Driver
    jdbcUrl: jdbc:mysql://localhost:3316/demo_ds_1?serverTimezone=UTC&useUnicode=true&characterEncoding=utf-8&useSSL=false&allowPublicKeyRetrieval=true
    username: root
    password: 
    autoCommit: false
...
public class Transaction2pcXaRawJdbcExampleApplication {
    ...
    static private DataSource getShardingDatasource() throws IOException, SQLException {
        String fileName = "D:\\geek\\homework\\shardingSphere-jdbc-example\\transaction-example\\transaction-2pc-xa-raw-jdbc-example\\src\\main\\resources\\sharding-databases-tables.yaml";
